...
for minion in htmlList:
    print("<tr>\n")
    print("<td align ='center'>"+str(minion[1])+"</td><td align ='center'>"+str(minion[2])+"</td><td align ='center'>"+str(minion[3])+"</td><td align ='center'>"+str(minion[4])+"</td><td align ='center'>"+str(minion[5])+"</td><td align ='center'>"+str(minion[0])+"</td>\n")
    print("</tr>\n")
print("</table>\n")
print("</body>\n")
print("</html>")
